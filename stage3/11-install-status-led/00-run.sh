...
# Note: LED transitions between flash-blue (disconnected) and green (connected)
# are now controlled directly by mqtt-client.js via connection event handlers.
# The status-led-iot.service is no longer needed.
