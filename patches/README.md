...
| 2026-08-20 | [`2026-08-20-ngrok-session-reclaim`](./2026-08-20-ngrok-session-reclaim/) | devices already carrying the 2026-08-19 patch (js **and** unit); accepts exactly one prior js sha and **requires** the BUG-039 unit — apply 2026-08-19 first | High — one connect/disconnect cycle wedges remote SSH until `mqtt-client` restarts; this is the delivery path every other patch ships over |
