...
> **v1.0.11 and v1.1.5 carry EVERY fix below and appear in no row's affected-versions
> cell.** Both were released 2026-08-25 (`ISSUE-065`) and both built images were checked
> file by file: of the ten patches here, **none is in a would-apply state** on a freshly
> flashed device — three report `NO-OP — device is AHEAD`, three sit exactly on their
...
> device would downgrade it. The `SUPERSEDED_SHAS` gate refuses to, and that gate is the
> only thing standing between an operator and a silent regression — see
> *A device flashed to v1.0.11 or later is AHEAD of most of this lineage*.
