...
| 2026-08-19 | [`2026-08-19-device-ready-flag-privatetmp`](./2026-08-19-device-ready-flag-privatetmp/) **— SUPERSEDED by 2026-08-20** | all shipped versions are affected; patch accepts stock v1.0.8–v1.0.10 / v1.1.2–v1.1.4 + 2026-06 field-patch intermediates (checksum-gated, js **and** unit) | High — ready receipt reprints on every service restart; printer prints/beeps overnight in a customer's office |
